...
public class SplashScreenActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    RelativeLayout splashContainerLayout;
    ...
    protected void onStart() {
        ...
        if (isNetworkAvailable()) {
            ...
            Snackbar.make(splashContainerLayout, getString(R.string.no_connection), Snackbar.LENGTH_SHORT).show();
            settingsRequest();
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.e(TAG, "latitude" + location.getLongitude());
